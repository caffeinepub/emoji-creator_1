...
export class Backend implements backendInterface {
    ...
    async deleteEmoji(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteEmoji(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllEmojiConfigs(): Promise<Array<EmojiConfig>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllEmojiConfigs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEmoji(arg0: bigint): Promise<EmojiConfig> {
        if (this.processError) {
            try {
                const result = await this.actor.getEmoji(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveEmoji(arg0: EmojiConfig): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveEmoji(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async seedSampleEmojis(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedSampleEmojis();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
